                ...
                <div className={`${DownloadStyle.row} row`}>
                    <div className="col-md-6">
                        ...
                        <div className={DownloadStyle.downloaddata_hdng}>
                            ...
                            <Link href="#" target="_blank"><Image src="/images/android.svg" alt="Logos" width={800} height={800} style={{ width: '48%', height: 'auto', marginRight: '5px' }} /></Link>
                            <Link href="#" target="_blank"><Image src="/images/playstore.svg" alt="Logos" width={800} height={800} style={{ width: '48%', height: 'auto', marginLeft: '5px' }} /></Link>
                            <Link href="#" target="_blank"><Image src="/images/window.svg" alt="Logos" width={800} height={800} style={{ width: '100%', height: 'auto', marginTop: '10px' }} /></Link>
                        </div>

                        <div className={DownloadStyle.download_follow}>
                            <h6>Follow us on</h6>
                            <div className={DownloadStyle.download_followbox}>
                                <Link href="#" target="_blank"><Image src="/images/socialIcons/facebook.svg" alt="Logos" width={800} height={800} style={{ width: '100%', height: 'auto' }} /></Link>
